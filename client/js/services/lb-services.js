...
/**
 * @ngdoc object
 * @name lbServices.Slack
 * @header lbServices.Slack
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Slack` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Slack#sendMessage
         * @methodOf lbServices.Slack
         *
         * @description
         *
         * <em>
         ...
         */
        "sendMessage": {
          url: urlBase + "/Slack/sendMessage",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Slack#receiveMessage
         * @methodOf lbServices.Slack
         *
         * @description
         *
         ...
         */
        "receiveMessage": {
          url: urlBase + "/Slack/receiveMessage",
          method: "POST"
        },
      }
    );
    ...
    /**
    * @ngdoc property
    * @name lbServices.Slack#modelName
    * @propertyOf lbServices.Slack
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Slack`.
    */
